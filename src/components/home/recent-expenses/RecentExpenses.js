...
export default function RecentExpenses(props) {
   return (
      <div className="expenseContainer bg-gray-100 rounded-md w-full h-20 hover:cursor-pointer hover:bg-gray-200 flex items-start justify-center overflow-hidden duration-150 ease-in text-gray-600">
